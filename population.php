...
<ul>
  ...
  <div class="pi ci"><a href="population.php"><img src="title3.gif" style= width:70px;height:70px;><u>ประชากร</u></a></div>
  <div class="pi"><a href="map.php"><img src="title4.gif" style= width:70px;height:70px;>แผนที่</a></div>
  <div class="pi"><a href="image.php"><img src="title5.gif" style= width:70px;height:70px;>รูปภาพ</a></div>
</ul>
<?php
...
$q = mysqli_query( $conn, $sql );
    while ($f = mysqli_fetch_assoc($q)){
    echo "<h3>".$f['Ethnic_population']."&nbsp คน &nbsp( โดยประมาณ )</h3>";
}
?>
<br><br>
