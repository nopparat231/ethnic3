...
<div class="login-wrapper">
        <div class= "login-left">
            <img src="cover.png">
                <div class="h1">กดเพื่อลงทะเบียน</div>
        </div>

        <div class="login-right">
            <div class="h2">ลงทะเบียน</div>
        

        <form action="Register_db2.php" method="post">
        ...
        <div class="button-area">
                <button name="reg_user" class="btn btn-primary">ลงทะเบียน</button></button>
        </div>

        </form>
                <p>มีบัญชีผู้ใช้อยู่แล้ว? &nbsp;<a href="Login.php">เข้าสู่ระบบ</a></p>
</div>
    </div>
