...
<?php
  ...
  while ($f1 = mysqli_fetch_assoc($q1)){
   ...
   echo "<h5><input type='checkbox' name='del[]' value= '$id1' id= '$id1'/><label for='$id1' ></label></h5><h4>📍&nbsp".$nameplace1."</h4><br>";
  }
}
  else{
...
// save ร้านอาหาร
  ...
  while ($f2 = mysqli_fetch_assoc($q2)){
   ...
   $id2= $f2['Foodplace_id'];
   echo "<form  method='post' name='plandis'>";
   echo "<h5><input type='checkbox' name='del[]' value= '$id2' id= '$id2'/><label for='$id2' ></label></h5><h4>📍&nbsp".$nameplace2."</h4><br>";
}
}
  else{
...
$sql3 = "SELECT * FROM keeplocation kl join clothesplace cp on kl.Clothesplace_id = cp.Clothesplace_id
  ...
  while ($f3 = mysqli_fetch_assoc($q3)){
   ...
   echo "<form  method='post' name='plandis'>";
   echo "<h5><input type='checkbox' name='del[]' value= '$id3' id= '$id3'/><label for='$id3' ></label></h5><h4>📍&nbsp".$nameplace3."</h4><br>";
  }
}
  else{
...
// save วัฒนธรรม
    ...
    while ($f4 = mysqli_fetch_assoc($q4)){
     ...
     echo "<form  method='post' name='plandis'>";
     echo "<h5><input type='checkbox' name='del[]' value= '$id4' id= '$id4'/><label for='$id4' ></label></h5><h4>📍&nbsp".$nameplace4."</h4><br>";
    }
  }
...
echo "<form  method='post' name='plandis'>";
echo "<h5><input type='checkbox' name='del[]' value= '$id5' id= '$id5'/><label for='$id5' ></label></h5><h4>📍&nbsp".$nameplace5."</h4><br>";
}
}
else{
...
//echo "<input type='button' id='selectAll' onclick='checkAll()'></button>";
?>
</form>
<!-- <script>
