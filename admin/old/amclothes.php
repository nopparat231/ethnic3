...
<button class="tablinks"><i class='fas fa-book'> เสื้อผ้า</i></button></a>
...
<div class="container">
            <div class="row">
                <div class="col-md-12"> <br>
                    <h3>รายการเครื่องแต่งกาย <a href="AddEthnic.php" class="btn btn-info">+เพิ่มข้อมูล</a> </h3>
...
<button style='height:30px' type='submit' name='submit' value='ค้นหา' ><i class="fa fa-search"> ค้นหา</i></button></div>
                    ...
                    <table class="table table-striped  table-hover table-responsive table-bordered">
                        <thead>
                            <tr>
                                <th width="5%">Clothes_id</th>
                                <th width="45%">ชื่อ</th>
                                <th width="30%">รายละเอียด</th>
                                <th width="20%">Ethnic_id</th>                                            
                                <th width="5%">แก้ไข</th>
                                <th width="5%">ลบ</th>
                            </tr>
                        </thead>
